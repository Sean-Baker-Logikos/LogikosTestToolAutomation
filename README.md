...
A new window should open at the bottom with a command prompt. In the terminal window, enter:
    ...
    python -m pip install git+https://github.com/Sean-Baker-Logikos/LogikosTestToolAutomation.git

![Install LogikosTestToolAutomation](/LogikosTestToolAutomation/Documentation/Install_LogikosTestToolAutomation.png)

# Run Sample Code

In your working folder, create a file list_test_tools.py and open that file in Visual Studio Code
